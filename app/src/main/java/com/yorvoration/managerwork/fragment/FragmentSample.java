...
public class FragmentSample extends Fragment {
    ...
    public void onViewCreated(View view,Bundle savedInstanceState) {
        ...
        SwipeRefreshLayout swiperefleshhome = view.findViewById(R.id.swiperefleshhome);
        readdatasql();
        readfirebasedata();
        swiperefleshhome.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                readfirebasedata();
                swiperefleshhome.setEnabled(false);
            }
        });
