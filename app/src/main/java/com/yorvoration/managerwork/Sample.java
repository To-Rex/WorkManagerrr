...
import com.yorvoration.managerwork.fragment.FragmentHot;
import com.yorvoration.managerwork.fragment.FragmentKubik;
import com.yorvoration.managerwork.fragment.FragmentNews;
import com.yorvoration.managerwork.fragment.FragmentSample;
import com.yorvoration.managerwork.fragment.FragmentSettings;
import com.yorvoration.managerwork.fragment.FragmentUser;
import com.yorvoration.managerwork.fragment.Fragmenttop;
...
public class Sample extends AppCompatActivity {
    ...
    String UID, TIL, REJIM, KALIT, PAROL,rool;
        ...
        documentReference.get().addOnSuccessListener(documentSnapshot -> {
            if (documentSnapshot.exists()) {
                String ism = documentSnapshot.getString("ISMI"),
                        ...
                        photoinfo = documentSnapshot.getString("MALE"),
                ...
                if (Objects.equals(photoinfo,"0")){
                    imgsozdeuser.setBackgroundResource(R.drawable.imgefemale);
                }
            }
        });
